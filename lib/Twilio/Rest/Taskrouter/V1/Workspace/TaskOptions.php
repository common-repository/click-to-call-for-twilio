...
class CreateTaskOptions extends Options {
    ...
    /**
     * Url-encoded JSON string describing the attributes of this task. This data will be passed back to the Workflow's AssignmentCallbackURL when the Task is assigned to a Worker. An example task: `{ "task_type": "call", "twt_call_sid": "CAxxx", "customer_ticket_number": "12345" }`
     * 
     * @param string $attributes Url-encoded JSON string describing the attributes
     *                           of this task.
     * @return $this Fluent Builder
